    ...
    <div className='px-4 lg:px-24 bg-teal-100 items-center'>
        <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-48'>
            ...
            <div className='md:w-1/2 space-y-8 h-full'>
                ...
                <p className='md:w-4/5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil voluptate suscipit 
                    repellendus iure tenetur iusto porro illum, ex qui quisquam asperiores? Vitae aut 
                    itaque suscipit atque blanditiis voluptas voluptatem eveniet.</p>
                    <div>
